...
class Kiwoom(QAxWidget):
    ...
    def _opt10001(self, rqname, trcode):
        ...
        try:
            ...
            self.opt10001_output['capital'].append(int(capital))
            self.opt10001_output['stockcnt'].append(int(stockcnt))
            self.opt10001_output['creditratio'].append(float(creditratio))
            self.opt10001_output['yearmax'].append(int(yearmax))
            self.opt10001_output['yearmin'].append(int(yearmin))
            self.opt10001_output['stocksum'].append(int(stocksum))

            if(stockpercent == ""):
                self.opt10001_output['stockpercent'].append(0.0)  # None
            else:
                self.opt10001_output['stockpercent'].append(float(stockpercent))  # None

            self.opt10001_output['foreginratio'].append(float(foreginratio))
            self.opt10001_output['substitude'].append(float(substitude))
            self.opt10001_output['per'].append(float(per))
            self.opt10001_output['eps'].append(float(eps))
            self.opt10001_output['roe'].append(float(roe))
            self.opt10001_output['pbr'].append(float(pbr))
            self.opt10001_output['ev'].append(float(ev))
            self.opt10001_output['bps'].append(float(bps))
            self.opt10001_output['sale'].append(int(sale))
            self.opt10001_output['operateprofit'].append(int(operateprofit))
            self.opt10001_output['netincome'].append(int(netincome))
            self.opt10001_output['max250'].append(int(max250))
            self.opt10001_output['min250'].append(int(min250))
            self.opt10001_output['open'].append(int(open))
            self.opt10001_output['high'].append(int(high))
            self.opt10001_output['low'].append(int(low))
            self.opt10001_output['max'].append(int(max))
            self.opt10001_output['min'].append(int(min))
            self.opt10001_output['standard'].append(int(standard))
            self.opt10001_output['signprice'].append(int(signprice))
            self.opt10001_output['signcnt'].append(int(signcnt))
            self.opt10001_output['max250day'].append(max250day)
            self.opt10001_output['max250ratio'].append(float(max250ratio))
            self.opt10001_output['min250day'].append(float(min250day))
            self.opt10001_output['min250ratio'].append(float(min250ratio))
            self.opt10001_output['value'].append(int(value))
            self.opt10001_output['prevsymbol'].append(prevsymbol)
            self.opt10001_output['prevprice'].append(int(prevprice))
            self.opt10001_output['prevratio'].append(float(prevratio))
            self.opt10001_output['volume'].append(int(volume))
            self.opt10001_output['prevvolume'].append(float(prevvolume))
